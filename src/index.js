...
export default class extends Component {
  ...
  initState(props, updateIndex = false) {
    ...
    // now need to handle iPhone get window height not correct issue.
    // ------------------------------------------------------------------
    const X_WIDTH = 375;
    const X_HEIGHT = 812;
    ...
    const { height: W_HEIGHT, width: W_WIDTH } = Dimensions.get('screen');
    let isIPhoneX = false;
    ...
    const height =  Dimensions.get('screen').height - (isIPhoneX?78:0);
